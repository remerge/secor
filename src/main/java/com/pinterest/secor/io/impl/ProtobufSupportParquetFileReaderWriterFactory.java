 ...
 */
public class ProtobufSupportParquetFileReaderWriterFactory implements FileReaderWriterFactory {
    ...
    public ProtobufSupportParquetFileReaderWriterFactory(SecorConfig config) {
